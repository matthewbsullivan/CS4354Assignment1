...
public class Movie implements Serializable{
    ...
    public Movie newMovie() {
        ...
        System.out.print("Enter movie SKU (integer, must be unique): ");
        sku = s.nextInt(); //Uniqueness checked in Inventory.addMovie

        do {
            System.out.print("Enter quantity available (cannot be a " +
                    "negative number): ");
            qty = s.nextInt();
        ...
        do {
            System.out.print("Enter movie title (e.g. Turner & Hooch): ");
            title = s.nextLine();
